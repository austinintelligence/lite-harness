# ADR 0008: Resource-scoped public authorization

- Status: accepted
- Date: 2026-07-14
- Requirement: D08
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 188-188
...
> Every public request is authorized against app, tenant, user, and resource.
...
- Rejected: endpoint-only authentication without tenant, user, and resource checks. It weakens the selected local-first boundary or creates a second architecture to support.
