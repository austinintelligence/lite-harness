# ADR 0025: Third-party plugins run out of process

- Status: accepted
- Date: 2026-07-14
- Requirement: D25
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 211-212
...
> Third-party plugins run out of process by default; only reviewed built-ins may run in a trusted host process.
...
- Rejected: loading unreviewed third-party code into the trusted host process. It weakens the selected local-first boundary or creates a second architecture to support.
