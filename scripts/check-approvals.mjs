...
try {
  ...
  if (!report) throw new Error("Approval security suite did not produce JSON reporter output");
  ...
  if (evidenceOutput) {
    writeVitestEvidence({
      ...
      command: "pnpm test:approvals",
      report: evidenceReport,
      requirementIds: ["R11-0885", "R27-2234", "R27-2235", "R27-2237", "R34-2900"],
      regressionIds: ["BD-028-REGRESSION", "BD-029-REGRESSION"],
      claims: {
        boundaries: {
  ...
  if (!passed) throw new Error("Approval security suite did not produce a zero-skip pass");
