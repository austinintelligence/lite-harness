# ADR 0023: Kernel depends only on contracts

- Status: accepted
- Date: 2026-07-14
- Requirement: D23
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 208-209
...
> The kernel depends on contracts, never on a concrete provider, integration, browser, or third-party plugin.
...
- Rejected: kernel imports of concrete providers, browsers, integrations, or plugins. It weakens the selected local-first boundary or creates a second architecture to support.
