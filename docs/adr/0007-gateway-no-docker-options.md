# ADR 0007: Gateway rejects raw Docker authority

- Status: accepted
- Date: 2026-07-14
- Requirement: D07
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 187-187
...
> Gateway never accepts raw Docker options, paths, mounts, or commands.
...
- Rejected: passing mounts, commands, paths, or daemon options through public requests. It weakens the selected local-first boundary or creates a second architecture to support.
