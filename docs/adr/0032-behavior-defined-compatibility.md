# ADR 0032: Compatibility is defined by behavior

- Status: accepted
- Date: 2026-07-14
- Requirement: D32
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 226-227
...
> The compatibility test suite decides what behavior is preserved; file and folder similarity to OpenClaw is not a goal.
...
- Rejected: using file and folder similarity as compatibility evidence. It weakens the selected local-first boundary or creates a second architecture to support.
