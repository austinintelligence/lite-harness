...
try {
  execFileSync(process.execPath, [
    resolve(root, "node_modules", "vitest", "vitest.mjs"), "run", "test/optional-systems-manager.test.ts", "test/skill-lifecycle.test.ts",
...
function writeEvidence(output, report) {
  ...
  const document = {
    ...
    testIds: ["BD-038-REGRESSION", "BD-044-REGRESSION"],
  };
