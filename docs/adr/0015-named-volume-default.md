# ADR 0015: Managed named-volume workspaces

- Status: accepted
- Date: 2026-07-14
- Requirement: D15
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 196-196
...
> Managed Docker named volumes are the default workspace mode.
...
- Rejected: arbitrary host bind mounts as the default workspace mode. It weakens the selected local-first boundary or creates a second architecture to support.
