...
import {
  ...
  DeleteProviderConnectionResponseSchema,
  ErrorDetailSchema,
  ErrorEnvelopeSchema,
  GatewayHealthSchema,
...
const publicSchemas: Record<string, unknown> = {
  ...
  CreateProviderConnection: CreateProviderConnectionRequestSchema,
  CreateWorkspace: CreateWorkspaceRequestSchema,
  DeleteProviderConnectionResponse: DeleteProviderConnectionResponseSchema,
  ...
  ModelCatalogRecord: ModelCatalogRecordSchema,
  ModelListResponse: ModelListResponseSchema,
  PublishArtifact: PublishArtifactRequestSchema,
  ProviderConnectionListResponse: ProviderConnectionListResponseSchema,
  ProviderConnectionLogin: ProviderConnectionLoginRequestSchema,
  ProviderConnectionRecord: ProviderConnectionRecordSchema,
...
const routeContracts: Record<string, RouteContract> = {
  ...
  "GET /v1/models": { successStatus: "200", successSchema: "ModelListResponse", successDescription: "Available redacted model catalog" },
  "GET /v1/provider-connections": { successStatus: "200", successSchema: "ProviderConnectionListResponse", successDescription: "Owner-scoped provider connections" },
  "POST /v1/provider-connections": { requestSchema: "CreateProviderConnection", successStatus: "201", successSchema: "ProviderConnectionRecord", successDescription: "Provider connection metadata created" },
  "POST /v1/provider-connections/{connectionId}/login": { requestSchema: "ProviderConnectionLogin", successStatus: "200", successSchema: "ProviderConnectionRecord", successDescription: "Provider credential stored" },
  "DELETE /v1/provider-connections/{connectionId}": { successStatus: "200", successSchema: "DeleteProviderConnectionResponse", successDescription: "Provider connection deleted" },
...
const routeErrorStatuses: Record<string, string[]> = {
  ...
  "GET /v1/models": ["401", "403", "429"],
  "GET /v1/provider-connections": ["401", "403", "429"],
  "POST /v1/provider-connections": ["400", "401", "403", "409", "429"],
  "POST /v1/provider-connections/{connectionId}/login": ["400", "401", "403", "404", "429", "502", "503"],
  "DELETE /v1/provider-connections/{connectionId}": ["401", "403", "404", "409", "429"],
