# ADR 0001: Node and TypeScript implementation stack

- Status: accepted
- Date: 2026-07-14
- Requirement: D01
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 181-181
...
> TypeScript and Node are the main implementation stack.
...
- Rejected: a polyglot kernel or a native-first Rust/Go rewrite. It weakens the selected local-first boundary or creates a second architecture to support.
