# ADR 0010: Manager receives a resolved principal

- Status: accepted
- Date: 2026-07-14
- Requirement: D10
- Contract: `LITE_HARNESS_ARCHITECTURE_PLAN.md`, 5. Architecture decisions to freeze, lines 191-191
...
> Manager receives a resolved internal principal, never the external token.
...
- Rejected: forwarding public bearer tokens into the privileged Manager. It weakens the selected local-first boundary or creates a second architecture to support.
